...
from escola.serializers import EstudanteSerializer, EstudanteSerializerV2,CursoSerializer, MatriculaSerializer, MatriculaPorEstudanteSerializer, MatriculaPorCursoSerializer
...
class MatriculaPorEstudante(generics.ListAPIView):
    ...
    Parâmetros:
    - pk (int): O identificados primário do objeto. Deve ser um número inteiro.
    """
...
class MatriculaPorCurso(generics.ListAPIView):
    """
    Descrição da View:
    - Lista de Matriculas por id de Curso
    Parâmetros:
    - pk (int): O identificados primário do objeto. Deve ser um número inteiro.
    """
    def get_queryset(self):
